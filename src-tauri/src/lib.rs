...
pub fn run() {
    ...
    let app = builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            provider_oauth_start_device_flow,
            provider_oauth_poll_device_flow,
...
pub fn export_typescript_bindings(output_path: &str) -> Result<(), String> {
    let builder =
        tauri_specta::Builder::<tauri::Wry>::new().commands(tauri_specta::collect_commands![
            ...
            commands::providers::provider_oauth_start_device_flow,
            commands::providers::provider_oauth_poll_device_flow,
